...
export default function SerialSideBar() {
  return (
    <div className=' w-full flex flex-col justify-center items-center bg-color-3 rounded-md p-3 space-y-4 font-semibold text-md  text-color-1 ml-2 '>
       <h3> سریال های به روز شده</h3>

       <div className="w-full flex justify-center items-center rounded-md p-2 bg-color-2  cursor-pointer hover:opacity-80 custom-transition">
